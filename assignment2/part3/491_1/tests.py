...
def test_sum_gp_n_zero():
    """Test sum_gp with n=0."""
    assert solution.sum_gp(5, 0, 3) == 0

#coverage improvement iter 1
def test_sum_gp_n_negative():
    """Test sum_gp with n<0."""
    assert solution.sum_gp(5, -1, 3) == 0

#coverage improvement iter 1
def test_sum_gp_n_negative_large():
    """Test sum_gp with large negative n."""
    assert solution.sum_gp(10, -100, 2) == 0

#coverage improvement iter 1
def test_sum_gp_r_one():
    """Test sum_gp with r=1."""
    assert solution.sum_gp(5, 3, 1) == 15

#coverage improvement iter 1
def test_sum_gp_r_one_large_n():
    """Test sum_gp with r=1 and large n."""
    assert solution.sum_gp(2, 10, 1) == 20

#coverage improvement iter 1
def test_sum_gp_r_one_single_term():
    """Test sum_gp with r=1 and n=1."""
    assert solution.sum_gp(7, 1, 1) == 7

#coverage improvement iter 1
def test_sum_gp_r_one_zero_a():
    """Test sum_gp with r=1 and a=0."""
    assert solution.sum_gp(0, 5, 1) == 0

#coverage improvement iter 1
def test_sum_gp_r_one_negative_a():
    """Test sum_gp with r=1 and negative a."""
    assert solution.sum_gp(-3, 4, 1) == -12

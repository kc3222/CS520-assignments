...
#coverage improvement iter 1
def test_num_position_empty_string():
    """Test num_position with empty string."""
    assert solution.num_position("") == -1

#coverage improvement iter 1
def test_num_position_no_digits():
    """Test num_position with string containing no digits."""
    assert solution.num_position("abcdefghijklmnopqrstuvwxyz") == -1

#coverage improvement iter 1
def test_num_position_no_digits_with_spaces():
    """Test num_position with string containing no digits but spaces."""
    assert solution.num_position("hello world") == -1

#coverage improvement iter 1
def test_num_position_no_digits_special_chars():
    """Test num_position with string containing no digits but special characters."""
    assert solution.num_position("!@#$%^&*()") == -1

#coverage improvement iter 1
def test_num_position_only_digits():
    """Test num_position with string containing only digits."""
    assert solution.num_position("123456789") == 0

#coverage improvement iter 1
def test_num_position_single_digit():
    """Test num_position with string containing single digit."""
    assert solution.num_position("5") == 0

#coverage improvement iter 1
def test_num_position_digit_at_end():
    """Test num_position with digit at the end."""
    assert solution.num_position("abcdef9") == 6

#coverage improvement iter 1
def test_num_position_multiple_digits_first():
    """Test num_position returns first digit position."""
    assert solution.num_position("abc5def7ghi9") == 3
